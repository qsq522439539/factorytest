...
class Ui_widget(object):
    def setupUi(self, widget):
        ...
        self.label.setGeometry(QtCore.QRect(205, 410, 241, 30))
        ...
        self.pushButton7 = QtGui.QPushButton(widget)
        self.pushButton7.setGeometry(QtCore.QRect(145, 410, 61, 30))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton7.sizePolicy().hasHeightForWidth())
        self.pushButton7.setSizePolicy(sizePolicy)
        self.pushButton7.setCursor(QtGui.QCursor(QtCore.Qt.OpenHandCursor))
        self.pushButton7.setFocusPolicy(QtCore.Qt.StrongFocus)
    ...
    def retranslateUi(self, widget):
        widget.setWindowTitle(_translate("widget", "工具", None))
        ...
        self.pushButton2.setText(_translate("widget", "DL业务", None))
        ...
        self.pushButton5.setText(_translate("widget", "DLUL业务", None))
        self.pushButton6.setText(_translate("widget", "全部开始", None))
        self.pushButton7.setText(_translate("widget", "出厂设置", None))
